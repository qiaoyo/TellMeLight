...
- Imported the SES and removed three unused B-only fanout vias with `tools/hardware/finalize_rev_a4_route.py`.
...
- 0.10 mm drill / 0.25 mm via geometry accepted by the intended JLC process.
