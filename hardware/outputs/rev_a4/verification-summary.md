...
- Free ordinary JLC via rule: 0.45 mm outer diameter / 0.30 mm drill; no 0.10 mm drill microvias or 0.25mm paid small-hole vias are used.
...
- Imported the SES and added the manual D5_R, 3V3, and FLASH_IO1_MISO completion routes with `tools/hardware/finalize_rev_a4_route.py`.
...
- JLC DFM accepts free ordinary 0.45 mm outer / 0.30 mm drill vias and 0.10 mm trace/clearance without advanced/HDI pricing.
