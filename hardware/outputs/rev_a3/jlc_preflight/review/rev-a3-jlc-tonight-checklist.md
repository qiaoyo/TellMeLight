...
4. Open `hardware/outputs/rev_a3/jlc_preflight/README.md` for the Rev A3 assembly preflight package.
...
## Optional Rev A3 assembly preflight

If you want JLC to see the new protection candidates in one file tonight, use the preflight package:

- `hardware/outputs/rev_a3/jlc_preflight/tellmelight_rev_a3_jlc_assembly_preflight.zip`
- `hardware/outputs/rev_a3/jlc_preflight/assembly/rev_a3_jlc_bom_preflight.csv`
- `hardware/outputs/rev_a3/jlc_preflight/assembly/rev_a3_jlc_cpl_draft.csv`

Important: this is not a final production package. U6/R9/C17/R10 are in the Rev A3 preflight BOM/CPL, but they are not yet present in a real Rev A3 KiCad PCB/Gerber. If JLC warns about extra components, missing footprints, or draft placement, that is expected.
